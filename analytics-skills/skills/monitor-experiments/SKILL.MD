...
suggest_when: User asks "what experiments are running", "check on experiments", "experiment status", wants a periodic experiment health report, or asks about all active tests.
---
